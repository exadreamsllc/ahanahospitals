    ...
    <div style={{
      ...
      <header style={{
        ...
        <Link href="/" style={{ fontSize: "20px", fontWeight: 800, color: "#ffffff", textDecoration: "none", letterSpacing: "-0.5px" }}>
          dotheneeds <span style={{ color: "#a78bfa", fontWeight: 500, fontSize: "14px" }}>/ mindgym</span>
        </Link>
        <Link href="/quiz" style={{ fontSize: "13px", color: "#94a3b8", textDecoration: "none", border: "1px solid rgba(255,255,255,0.1)", padding: "6px 14px", borderRadius: "20px" }}>
        ...
        {!showResult ? (
          ...
          <div style={{
            ...
            <div style={{ display: "grid", gap: "10px" }}>
              ...
              <Link href="/quiz" className="ahana-button secondary" style={{ width: "100%", textDecoration: "none", display: "block" }}>
                Back to Declarations
              </Link>
            </div>
          </div>
